...
def test_gnb_model(classifier, scaler, features):
    ...
    for i, test_set in enumerate(test_sets, start=1):
        ...
        print(f'GNB percentage prediction on the test set {i} is:', prediction)

if __name__ == "__main__":
    classifier, scaler, features = train_gnb_model()
    test_gnb_model(classifier, scaler, features)